...
const GITHUB = 'https://github.com/amuuu2/Coda'
...
const capabilities = [
  {
    ...
    shot: withBase('/images/coda/sandbox-filesystem.png')
  },
  {
    icon: 'sparkles',
    title: 'Skills 技能系统',
  ...
  <div class="yx-home">
    ...
    <section class="yx-hero">
      ...
      <div class="yx-container yx-hero__inner">
        ...
        <h1 class="yx-hero__title"><span class="yx-accent">Coda</span></h1>
        ...
        <div class="yx-hero__shot">
          <img
            class="yx-hero__img"
            :src="withBase('/images/coda/product-overview.png')"
            alt="Coda 产品界面预览"
            loading="lazy"
          />
        </div>
    ...
    <section class="yx-section">
      <div class="yx-container">
        <header v-reveal class="yx-head">
          ...
          <p class="yx-head__sub">Coda 内置一套完整的 Harness——沙盒、技能、工具、子智能体与中间件，让智能体真正动手完成任务。</p>
        </header>
        <div class="yx-bento">
          <article
...
git clone --branch v0.7.1 --depth 1 https://github.com/amuuu2/Coda.git
cd Coda && ./scripts/init.sh
