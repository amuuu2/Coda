...
欢迎使用 Coda，这是一个智能知识库和知识图谱 Agent 开发平台。
...
::: tip API Key 获取
- **阿里百炼**：访问 [百炼控制台](https://bailian.console.aliyun.com/) 获取 API Key，在初始化脚本中选择 `DASHSCOPE_API_KEY`
- **硅基流动**：访问 [cloud.siliconflow.cn](https://cloud.siliconflow.cn/) 获取 API Key，在初始化脚本中选择 `SILICONFLOW_API_KEY`
