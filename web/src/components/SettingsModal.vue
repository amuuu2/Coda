    ...
    <div class="settings-container">
      ...
      <div class="settings-sider">
        ...
        <div v-if="showStarCard" class="settings-star-card">
          ...
          <p class="star-card-title">给 Coda 点个 Star</p>
          ...
          >
            <img
              ...
              src="https://img.shields.io/github/stars/amuuu2/Coda?label=Coda&style=social"
              alt="GitHub stars for Coda"
            />
...
const projectRepoUrl = 'https://github.com/amuuu2/Coda'
