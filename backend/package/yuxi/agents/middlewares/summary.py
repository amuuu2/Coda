"""Coda adapter for DeepAgents conversation summarization middleware."""
...
class YuxiSummarizationMiddleware(SummarizationMiddleware):
    """DeepAgents summarization middleware with Coda-specific tool-call sanitization."""
...
def create_summary_middleware(
    ...
    *,
    ...
    """Create DeepAgents summarization middleware using Coda's virtual outputs root."""
    middleware_kwargs = {
        "model": model,
