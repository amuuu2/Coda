...
TASK_TOOL_DESCRIPTION = """Launch a configured Coda subagent to handle an isolated task.
...
SUBAGENT_START_DESCRIPTION = """Start a configured Coda subagent asynchronously.
